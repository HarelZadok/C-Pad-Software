...
unsigned int WindowsSerial::getPort()
{
	return this->comPortNum;
}
...
bool WindowsSerial::begin(unsigned int _baud)
{
	/*
	#define CBR_110             110
	#define CBR_300             300
	...
	*/
	...
	if (this->comPortNum != NULL)
	{
		...
		return initializePort(portName, this->baud);
	}
	return false;
}
...
bool WindowsSerial::begin(unsigned int _baud, unsigned int _comPortNum)
{
	/*
	#define CBR_110             110
	#define CBR_300             300
...
bool WindowsSerial::initializePort(char portName[], unsigned int _baud)
{

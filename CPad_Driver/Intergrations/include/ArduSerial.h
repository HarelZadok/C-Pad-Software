...
{
public:
	inline static unsigned int ERROR_PORT = 9999;
	////////////////////////////////////////////////////////
	// Default Constructor
	WindowsSerial(unsigned int _comPortNum);
	WindowsSerial() = default;

	////////////////////////////////////////////////////////
	// Initialization/Admin Stuff
	void setPort(unsigned int _comPortNum);
	unsigned int getPort();
	bool begin(unsigned int _baud);
	bool begin(unsigned int _baud, unsigned int _comPortNum);
	bool connected();
	void end();
...
private:
	...
	bool initializePort(char portName[], unsigned int _baud);
};




extern WindowsSerial Serial0;
